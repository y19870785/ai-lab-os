...
| Python Files | 456 |
| Code Lines | 29,259 |
| Tests | 977 passed, 27 warnings in 49.17s（SP-008 Windows 本地候选验证，非跨平台 CI） |
| RFC | 17 |
| ADR | 36 |
...
当前工作为 SP-008 Internal Work Admission Boundary：**implementation candidate / Draft PR / Awaiting ChatGPT review / Not merged**。候选实现复用 SP-007 生命周期真相，覆盖 ApplicationRuntime、CEO Assistant、CLI 业务路径与 Scheduler producer；未经审查不得标记 Integrated 或 Verified。
...
> SP-007 System Lifecycle Admission Gate: APPROVED / MERGED / RECONCILED / ARCHIVED. SP-008 Internal Work Admission Boundary: implementation candidate / Draft PR / Awaiting ChatGPT review / Not merged。
