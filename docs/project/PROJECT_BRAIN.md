...
> Next Candidate Direction: Canonical Waiting-For Domain & Agenda Closure
> SP-016 Planning Status: PLANNING_BASELINE_DEFINED / NOT_APPROVED_FOR_IMPLEMENTATION / NOT_STARTED
...
| UserTask / Daily Agenda / Unified Inbox | Integrated / Verified | v0.34.0 Alpha 核心能力；Agenda 可选来源聚合仍待规划实现 |
...
- AGENDA-001：Daily Agenda 改为可选来源聚合器，避免 Reminder/Scheduler 关闭时整体不可用。
...
SP-016 Canonical Waiting-For Domain & Agenda Closure 已定义 planning baseline，但未批准实现、未启动；SP-017 Follow-up Interaction & Capture Closure、SP-018 Structured Work Log Query & Context Linking 与 SP-019 Daily Review & Follow-up Brief 仅为候选。SP-015、SP-015A 与 SP-015R 均已封存；当前没有产品 SP 或治理任务。
