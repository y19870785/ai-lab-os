...
> SP-017 Status: PLANNING_BASELINE_DEFINED / NOT_APPROVED_FOR_IMPLEMENTATION / NOT_STARTED
> SP-017 Design: RFC-026 Proposed / Planning Baseline; ADR-056 and ADR-057 Accepted
...
SP-016 Canonical Waiting-For Domain & Agenda Closure 已完成人工验收并封存，ACC-016 为 PASSED / FINAL；当前产品 SP 与治理任务均为 None。SP-017 Follow-up Interaction & Capture Closure 已定义“直接读取、模糊捕获、持久化确认、按 ID 明确写入”的规划基线，RFC-026 为 Proposed / Planning Baseline，ADR-056 与 ADR-057 为 Accepted，但生产实现仍未批准、未启动。SP-018 与 SP-019 仅为候选，均未批准、未启动。
