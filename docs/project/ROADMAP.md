...
| SP-021 | Canonical Trusted Interaction Domain | IMPLEMENTATION_AUTHORIZED / OPEN / DRAFT / IMPLEMENTATION_IN_PROGRESS / PENDING_INDEPENDENT_REVIEW / NOT_READY / NOT_MERGE_AUTHORIZED |
...
SP-021 已单独获得实现授权并进入 Draft PR；INT-001、PILOT-001 与 REL-036 仍未启动。
